  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 pb-20 max-w-4xl mx-auto px-6">
        <h1 className="text-4xl md:text-5xl font-serif italic mb-8">À propos</h1>
        ...
        <section className="space-y-6 text-muted-foreground leading-relaxed">
          ...
          <h2 className="text-2xl font-serif text-foreground pt-4">Notre mission</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-foreground pt-4">Notre approche</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-foreground pt-4">Nos valeurs</h2>
