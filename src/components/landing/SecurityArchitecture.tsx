...
export function SecurityArchitecture() {
  ...
  const nodes = (t("securityArch.tobam", { returnObjects: true }) as Array<{ role: string; name: string; desc: string }>) || [];
  const icons = [Users, ShieldCheck, Building2, FileCheck2, Server];
  return (
